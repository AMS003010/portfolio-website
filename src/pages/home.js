            ...
            <div className='introHomeContainer' style={divStyle}>
                <div className="introHome">
                    ...
                    <div style={{display:'flex'}}>
                        <a href='https://drive.google.com/file/d/1T3KL4hXJN6V61LveIog9jmnfJNPx_mA7/view?usp=sharing' target='blank' className="socialHomeLink">
            ...
            <div className="homeAboutMeWrapper">
                ...
                <div className="homeAboutMeContainer">
                    <div className="homeAboutMeContent">
                        I am Abhijith, a <span className="conTag">passionate</span> and forward-thinking BTECH Computer Science student based in the vibrant city of Bengaluru. Hailing from the beautiful city of Bengaluru, I find inspiration in the convergence of technology and innovation.
